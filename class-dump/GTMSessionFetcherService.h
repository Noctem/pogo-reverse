...
@class GTMSessionFetcherSessionDelegateDispatcher, NSArray, NSDictionary, NSHTTPCookieStorage, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSString, NSURLCredential, NSURLSessionConfiguration;
